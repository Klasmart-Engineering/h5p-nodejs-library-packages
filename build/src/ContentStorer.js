...
var ContentStorer = /** @class */ (function () {
     ...
     * @param user the user who wants to save the file
     */
    ContentStorer.prototype.cloneContent = function (contentId, parameters, metadata, mainLibraryName, user) {
        return __awaiter(this, void 0, void 0, function () {
            var filesInOldParams, fileReferencesInNewParams, filesToCopyFromTemporaryStorage, newContentId, oldFilesToCopy, dirty;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getFilesInParams(contentId, user)];
                    case 1:
                        filesInOldParams = _a.sent();
                        return [4 /*yield*/, this.contentFileScanner.scanForFiles(parameters, mainLibraryName)];
                    case 2:
                        fileReferencesInNewParams = _a.sent();
                        return [4 /*yield*/, this.determineFilesToCopyFromTemporaryStorage(fileReferencesInNewParams, filesInOldParams)];
                    case 3:
                        filesToCopyFromTemporaryStorage = _a.sent();
                        return [4 /*yield*/, this.contentManager.createOrUpdateContent(metadata, parameters, user, undefined)];
                    case 4:
                        newContentId = _a.sent();
                        oldFilesToCopy = fileReferencesInNewParams.filter(function (newFile) {
                            return !newFile.temporary &&
                                filesInOldParams.some(function (oldFile) { return newFile.filePath === oldFile; });
                        });
                        return [4 /*yield*/, this.copyFilesFromContent(oldFilesToCopy, user, contentId, newContentId)];
                    case 5:
                        dirty = _a.sent();
                        return [4 /*yield*/, this.copyFilesFromTemporaryStorage(filesToCopyFromTemporaryStorage, user, newContentId, false // If new content is stored, the temporary
                    ...
                    case 8:
                        _a.sent();
                        _a.label = 9;
                    case 9: return [2 /*return*/, newContentId];
                }
            });
        });
    };
     ...
     * parameters must be saved again
     */
    ContentStorer.prototype.copyFilesFromContent = function (files, user, oldContentId, newContentId) {
        return __awaiter(this, void 0, void 0, function () {
            var contentExists, dirty, _i, files_2, fileToCopy, exists, readable, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contentManager.contentExists(oldContentId)];
                    case 1:
                        contentExists = _a.sent();
                        if (!contentExists) {
                            log.error("content(".concat(oldContentId, ") does not exist"));
                            files.map(function (file) { return (file.context.params.path = ''); });
                        ...
                        _a.label = 2;
                    case 2:
                        if (!(_i < files_2.length)) return [3 /*break*/, 12];
                        fileToCopy = files_2[_i];
                        _a.label = 3;
                    case 3:
                        _a.trys.push([3, 10, , 11]);
                        return [4 /*yield*/, this.contentManager.contentFileExists(oldContentId, fileToCopy.filePath)];
                    case 4:
                        exists = _a.sent();
                        if (!exists) {
                            throw new Error("File does not exist in content(".concat(oldContentId, ")"));
                        }
                        return [4 /*yield*/, this.contentManager.getContentFileStream(oldContentId, fileToCopy.filePath, user)];
                    case 5:
                        readable = _a.sent();
                        _a.label = 6;
                    case 6:
                        _a.trys.push([6, , 8, 9]);
                        log.debug("Adding file ".concat(fileToCopy, " to content id ").concat(newContentId));
                        return [4 /*yield*/, this.contentManager.addContentFile(newContentId, fileToCopy.filePath, readable, user)];
                    case 7:
                        _a.sent();
                        return [3 /*break*/, 9];
                    case 8:
                    ...
                    case 10:
                        e_1 = _a.sent();
                        log.error("Failed to copy file(".concat(fileToCopy, "): ").concat(e_1));
                        fileToCopy.context.params.path = '';
                        dirty = true;
                        return [3 /*break*/, 11];
                    case 11:
