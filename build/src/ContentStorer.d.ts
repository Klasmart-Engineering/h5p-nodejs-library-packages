...
export default class ContentStorer {
     ...
     * @param user the user who wants to save the file
     */
    cloneContent(contentId: ContentId, parameters: any, metadata: IContentMetadata, mainLibraryName: ILibraryName, user: IUser): Promise<ContentId>;
    /**
